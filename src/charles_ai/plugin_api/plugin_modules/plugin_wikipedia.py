...
spec = {
    "plugin": "wikipedia",
    "description": "Gets the summary of a wikipedia page. Use this plugin when asked for more information than you know, or if the user asks you to look something up.",
    "args": {
